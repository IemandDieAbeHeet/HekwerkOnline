...
?>
    <main>
        <div class="wrapper">
            ...
            <h1 class="productsoort">Onze houten poorten</h1>

            <div class="grid">
                <?php
                    require "includes/dbh.inc.php";

                    $sql = "SELECT * FROM products WHERE category='houtenpoort' ORDER BY id ASC";
                            ...
                            while($product = mysqli_fetch_assoc($result)) {
                                ...
                                <div class="product">
                                    ...
                                    <ul>
                                        ...
                                        <li><p><?php echo 'Prijs (per hek): €' . $product['price'] ?></p></li>
